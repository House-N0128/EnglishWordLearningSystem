...
CREATE TABLE `t_word` (
  ...
  PRIMARY KEY (`wordId`),
  UNIQUE KEY `uk_book_spelling` (`wordBookId`,`englishSpelling`),
...
-- Dump completed on 2026-05-20  9:34:40
